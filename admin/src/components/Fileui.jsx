...
const Fileui = () => {
  return (
    <div className='cursor-pointer flex flex-col items-center bg-red-200 hover:bg-red-300 transition-all border border-red-600 rounded-md border-dashed'>
      <svg className="w-8 mt-6 h-8 mb-4 sm:mt-14 text-red-500 "  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
            ...
            <p className="text-xs mb-5 sm:mb-16 text-red-700">SVG, PNG or JPG  (MAX. 800x400px)</p>
      </div>
  )
}
